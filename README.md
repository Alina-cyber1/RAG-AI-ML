...
<!-- Здесь покажите, как выглядит ваша система. Замените пути на свои картинки -->
| Веб-интерфейс | Пример диалога в боте |
| :---: | :---: |
| ![Главный экран веб-интерфейса](images/web_interface.png) | ![Диалог с Telegram-ботом](images/tg_bot_dialog.png) |

<!-- Можно добавить еще скриншот с примером отказа от ответа -->
...
![График влияния размера чанка](images/chunk_size_exp.png)
